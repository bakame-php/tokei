...
We accept bug reports via issues created on [GitHub](https://github.com/bakame-php/tokei/issues).
...
- **Always try the [main branch](https://github.com/bakame-php/tokei)** - to see if the reported bug has not already been fixed.
...
We accept contributions via Pull Requests on [GitHub](https://github.com/bakame-php/tokei/pull).
