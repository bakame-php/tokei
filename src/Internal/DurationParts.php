...
final readonly class DurationParts
{
    ...
    public function decompose(): array
    {
        ...
        if (0 === $this->nanoseconds % 1_000_000) {
            $parts['milliseconds'] = intdiv($this->nanoseconds, 1_000_000);

            return $parts;
        }

        if (0 === $this->nanoseconds % 1_000) {
            $parts['microseconds'] = intdiv($this->nanoseconds, 1_000);

            return $parts;
        }

        $parts['nanoseconds'] = $this->nanoseconds;
