...
final class IntervalTest extends TestCase
{
    ...
    public function testShiftStartMovesOnlyStart(): void
    {
        ...
        $updated = $range->shiftBound(duration: Duration::of(hours: 1), to: Bound::Start);
    ...
    public function testShiftEndMovesOnlyEnd(): void
    {
        ...
        $updated = $range->shiftBound(duration: Duration::of(hours: 2), to: Bound::End);
    ...
    {
        self::assertSame($expected, $interval->splitAt($split)->formatAll(IntervalFormat::Iso8601StartDuration));
    }
