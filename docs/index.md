...
echo "If I start working again at ", $startedNewShiftAt->format(TimeFormat::Clock), PHP_EOL;
echo "I will end today's shift at ", $shouldStopAt->format(TimeFormat::Clock), PHP_EOL;
```
...
I will end today's shift at 23:47:00
```